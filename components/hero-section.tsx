        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 md:order-1">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-balance leading-relaxed">
              Full Stack Developer — React, Vue, Node, TypeScript & Arquitetura
              Limpa
            </p>

            <p className="text-base md:text-lg text-muted-foreground mb-10 leading-relaxed max-w-lg">
              Construo aplicações modernas, rápidas e escaláveis, sempre focando
              em boas práticas, organização e experiência do usuário. Gosto de
              transformar problemas complexos em soluções claras e bem
              estruturadas.
            </p>
